...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-crypticcoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-crypticcoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-crypticcoin -o bitcore-lib-crypticcoin.js';
    }
